...
function App() {
  ...
  return (
    <BrowserRouter>
      <TopBar />
      <Routes>
        <Route path="/" element={<ProtectedGameRoute />}></Route>
        <Route
          path="/ColoredGame"
          element={<GameTal rows={20} columns={10} />}
        ></Route>
        <Route path="/LightGame" element={<Game />}></Route>
        <Route path="/signup" element={<SignUp />}></Route>
        <Route path="/login" element={<Login />}></Route>
        <Route path="/highscores" element={<Highscore />}></Route>
      </Routes>
    </BrowserRouter>
  );
}
