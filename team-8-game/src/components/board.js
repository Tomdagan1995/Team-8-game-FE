  ...
  return (
    <>
      ...
      >
        ...
        <span className="t-score-label"> {level}</span>
        <span>
          <button
            onClick={sendScore}
            className="btn btn-primary"
            style={{
              backgroundColor: " rgb(49, 96, 73)",
              borderColor: " rgb(49, 96, 73)",
            }}
          >
            Save Score
          </button>
      ...
      <h3>
        Up Arrow will change the direction of the Shape, SpaceBar will drop the
        Shape 10 squares.
      </h3>
    </>
  );
